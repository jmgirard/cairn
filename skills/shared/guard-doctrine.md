...
complete`); for the counts themselves, the tracking-rules derived-figures
rule applies.
...
**A universal claim over a milestone's own artifacts is a count claiming zero exceptions, and carries the count rule's pin obligation above.**
