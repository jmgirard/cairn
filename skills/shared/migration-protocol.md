...
3. **Inventory + proposal.** List every legacy tracking file and every live
   ...
   proposed disposition appear verbatim in the chat above the gate,
   best-effort, with the compact form in the chip itself (Mandated-substance rule) —
...
7. **Accept by audit + ledger.** The PR is mergeable only when: (a) the
   ...
   **migration ledger** in the PR description accounts for every legacy
   ...
   its compact form in the chip itself (Mandated-substance rule) — the PR description
