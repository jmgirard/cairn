...
- Design-interview skill, two-pass (overall interview → principle interview; proposed gold standard): encode question-quality + pass-2 reconciliation findings so interviews improve on Opus; alternative/complement: Fable elevation behind a brief-style gate — added 2026-07-11 — references/design-interview-notes.md
