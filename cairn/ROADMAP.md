...
_Last hygiene check: 2026-07-12 (M38 done + archived; pruned M33 to the 5-terminal cap)_
...
|---|---|---|---|---|---|
| M39 | Search-first candidate creation | in-progress | — | normal | milestones/M39-search-first-candidate-creation.md |
...
- M06 deferred minor steals (one row per C6; promote individually if wanted): scored-rubric hygiene audit for /milestone, conflicts_with/parallel task metadata, complexity-scored split advisory, tiered tool exposure, strict schemas for machine-written fragments, search-first candidate creation (→ M39, graduates at completion) — added 2026-07-11; principles-touched slot shipped as M38 2026-07-12; 2 items pruned 2026-07-12 as already shipped (branch↔milestone mapping → milestone Branch/PR field; focus-lens fan-out → M17) — references/competitive-landscape.md + per-system notes
