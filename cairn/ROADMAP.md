...
|---|---|---|---|---|---|
| M58 | Rulebook doctrine placement — governance up, validation doctrine out, registry pointer | in-progress | — | normal | milestones/M58-rulebook-doctrine-placement.md |
