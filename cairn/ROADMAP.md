...
|---|---|---|---|---|---|
| M61 | External de-risking — env check, migration dry-run, Windows story, python CI parity | in-progress | — | high | milestones/M61-external-derisking.md |
...
- Public release prep: **fully planned 2026-07-16 as M61 (de-risking) + M62 (LICENSE, README, DRAFT removal)**; v1.0 tag = a `/cairn-release` run after M62 merges; positioning + DESIGN refresh shipped via M54 — row graduates when M61+M62 ship — added 2026-07-11 — DRAFT_2 §11, reviews/archive/RR01 rec 14/§10
...
- Python profile Codecov/CI parallel: **absorbed into M61 (T4) 2026-07-16** — graduates at M61 completion — added 2026-07-12 — M52 Out
