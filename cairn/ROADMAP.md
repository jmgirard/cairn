...
_Last hygiene check: 2026-07-12 (M21 done+archived; M18 row pruned per 5-done retention)_
...
|---|---|---|---|---|---|
| M24 | Scaffold-drift detection in the audit | planned | — | normal | milestones/M24-scaffold-drift-check.md |
