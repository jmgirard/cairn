...
_Last hygiene check: 2026-07-11 (M10 done+archived; M05 row pruned per 5-done retention)_
...
|---|---|---|---|---|---|
| M11 | Shift phase headers up one level (H1 unit / H2 phase) | planned | — | normal | milestones/M11-phase-header-levels.md |
...
- Deterministic-script wiring beyond /milestone: wire /milestone-review's consistency gate to validate and /milestone-plan's readiness to next; add a --json output mode; a date-format sweep in validate — added 2026-07-11 — M10 Out
