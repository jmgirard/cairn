...
- Milestone-file mechanics: section write allow-lists per skill, baseline-commit capture at implement start, prior-milestone lessons harvest at plan time, Sync Impact Report on rulebook/principle changes, session-end repo-lessons capture — added 2026-07-11 — references/competitive-landscape.md
