...
|---|---|---|---|---|---|
| M57 | references/ + linking hardening — synthesis notes, INDEX lint, dangling-ID advisory | in-progress | — | normal | milestones/M57-references-linking-hardening.md |
...
- references/ + linking hardening (M56 dispositions): name the synthesis-note page type in the file map (practice outgrew "source summaries" — competitive-landscape.md et al.); add a references lint to cairn_validate (INDEX↔disk orphan check, sibling of roadmap↔disk); add a dangling M/D-token ADVISORY (WARN tier, tolerant of repo-qualified refs + example prose — the M57/M99 FP hazards) — added 2026-07-16; promoted → M57 (planned 2026-07-16; row graduates at completion per the M35 lesson) — references/llm-wiki.md
