...
- Competitive-landscape research: survey neighboring skills/plugins/frameworks — Anthropic official plugins (feature-dev's explore→architect→review workflow, claude-md-management's memory upkeep, code-review) and community systems (ccpm ~8k★ GitHub-Issues PM, GitHub spec-kit, Task Master, BMAD-METHOD, Backlog.md, Meridian) — deliverables: per-system notes in references/, a steal-list of adoptable ideas, and a written uniqueness case (or refocus) for cairn: what does markdown-native tracking + status gatekeeping + review/approval gates + R-toolchain doctrine offer that these don't? — added 2026-07-11 — user request
