...
|---|---|---|---|---|---|
| M62 | Release docs — LICENSE, README worked example + framing, DRAFT removal | in-progress | M61 | high | milestones/M62-release-docs.md |
...
- Public release prep: **M61 (de-risking) shipped 2026-07-16; M62 (LICENSE, README, DRAFT removal) in progress**; v1.0 tag = a `/cairn-release` run after M62 merges; positioning + DESIGN refresh shipped via M54 — row graduates when M62 ships — added 2026-07-11 — DRAFT_2 §11, reviews/archive/RR01 rec 14/§10
