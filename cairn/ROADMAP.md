...
_Last hygiene check: 2026-07-16 (M62 done + archived; M57 pruned under terminal-row retention; public-release-prep candidate converted to a v1.0-release row)_
...
|---|---|---|---|---|---|
| M63 | /design-interview note-and-leave ingestion — detect, formalize with #N lineage, bank the repoint | review | — | normal | milestones/M63-design-interview-ingestion.md |
