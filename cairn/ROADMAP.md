...
_Last hygiene check: 2026-07-13 (M54 release positioning + DESIGN refresh done + archived; struck the positioning/DESIGN slices from the release-prep candidate at plan; pruned M49 under terminal-row retention)_
...
|---|---|---|---|---|---|
| M55 | Milestone-file cap exempts the Review section | planned | — | normal | milestones/M55-milestone-file-cap.md |
