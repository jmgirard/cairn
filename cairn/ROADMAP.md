...
_Last hygiene check: 2026-07-16 (M68 done + archived; candidate row graduated; M63 pruned under terminal-row retention)_
...
|---|---|---|---|---|---|
| M69 | Cap-overrun diagnostic — per-section breakdown + single-pass compression discipline | in-progress | — | normal | milestones/M69-cap-overrun-diagnostic.md |
