...
- [ ] T4: Draft the batched D-entry (supersedes D-003's routing-chip clause and D-022's one-click mechanism; absorbs D-019; narrows D-123's turn-break prong); preview verbatim per the durable-record rule.
