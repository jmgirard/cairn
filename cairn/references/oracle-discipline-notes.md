...
Pagination: —.
Extraction: read against the ackwards artifacts at assessment time; the assessed repo has moved on independently since, so the catalogue is a 2026-07-12 snapshot.
